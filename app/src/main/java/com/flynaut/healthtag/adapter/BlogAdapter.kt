...
class BlogAdapter(val activity: FragmentActivity?, private val dataSet: List<BlogDetails>) : RecyclerView.Adapter<BlogAdapter.ViewHolder>() {


    // Create new views (invoked by the layout manager)
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = AdapterBlogItemBinding.inflate(inflater, parent, false)
    ...
    class ViewHolder(private val binding: AdapterBlogItemBinding) : RecyclerView.ViewHolder(binding.root) {
