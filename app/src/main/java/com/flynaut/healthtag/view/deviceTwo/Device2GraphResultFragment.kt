...
import com.flynaut.healthtag.databinding.FragmentDevice2GraphResultBinding
import com.flynaut.healthtag.view.BaseFragment

class Device2GraphResultFragment : BaseFragment<FragmentDevice2GraphResultBinding>() {
...
//        }
    ...
    override fun getLayoutResId(): Int {
        return R.layout.fragment_device2_graph_result
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(deviceId: String): Device2GraphResultFragment {
            val fragment = Device2GraphResultFragment()
            val bundle = Bundle()
